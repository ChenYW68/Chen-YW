---
title: "[2] Joint modeling and dynamic ensemble forecasting of influenza vaccine responses from complex longitudinal trajectories"
...
### Figure 1
<img src="https://chenyw68.github.io/Chen-YW/images/Papers/JMDF-Fig0.jpg" alt="Figure 1" width="800">

*Incomplete longitudinal trajectories of pre- and post-vaccination HAI titers collected from 30 randomly selected participants over eleven years.*
...
<figure id="Figure4">
  ...
  <figcaption align="center">
    <strong>Figure 4:</strong> The interaction effects between human age and historical longitudinal pre-vaccination HAI titers on future vaccination responses.
  </figcaption>
</figure>
*the interaction effects between human age and historical longitudinal pre-vaccination HAI titers on future vaccination responses.*